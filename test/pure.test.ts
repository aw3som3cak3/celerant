...
const fakeSkill = (year: number): Skill => ({ code: 'x', family: 'f', subject: 'maths', format: 'numpad', year, mode: 'component', sprintable: true, requires: [], generate: () => ({ prompt: '', answer: { kind: 'int', v: 0 }, steps: [] }) });
